#!/bin/bash
#
# Docker instance management command: Uninstall
# ---------------------------------------------------------------------
...
# Uninstall container
echo
echo "- Uninstalling '$DOCKER_IMAGE' ('$DOCKER_INSTANCE_NAME') container ..."
docker container rm $DOCKER_INSTANCE_NAME --force > /dev/null 2>&1
echo "  ... done!"

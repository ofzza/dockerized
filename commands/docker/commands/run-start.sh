#!/bin/bash
#
# Docker instance management command: Start
# ---------------------------------------------------------------------
...
# Start container
echo
echo "- Starting '$DOCKER_IMAGE' ('$DOCKER_INSTANCE_NAME') container ..."
docker container start $DOCKER_INSTANCE_NAME > /dev/null 2>&1
echo "  ... done!"
